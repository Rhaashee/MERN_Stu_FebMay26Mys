...
const archivedLogFile = path.join(logsDir,"booking-archeived.log");
...
function appendLogAsync(message){
    ensureDirectories();
    return new Promise((resolve,reject)=>{
        const timeStamp = new Data().toString();
...
initializeBookingsFileSync,
readBookingsAsync,readBookingsSync,
writeBookingsAsync,writeFileSync,
appendBookingAsync, 
renameLogFileSync,
