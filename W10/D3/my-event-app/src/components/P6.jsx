...
// Instead of attaching a separate click handler to every element we attach one handler to the parent
...
// Code is cleaner and managable 
// Its useful when rendering many similar items

import {useState } from "react";

export function EventDeleagation(){
