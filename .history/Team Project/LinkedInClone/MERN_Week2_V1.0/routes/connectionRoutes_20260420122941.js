...
router.put("/accept/:requestId:",authMiddleware,connectionController.acceptRequests); // Accept request
router.put("/reject/:requestId:",authMiddleware,connectionController.rejectRequests); // Reject request
